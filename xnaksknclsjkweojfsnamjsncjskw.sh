...
echo
echo
toilet -f future "  BLACK ATTACKING TOOLS " | lolcat
echo
echo $yellow"<><><><><><><>$indigo"{SELAMAT DATANG}" $yellow<><><><><><><>"
echo $red
figlet -f future "  BCA-X666X " | lolcat
echo
echo $yellow"<><><><><><><><>$indigo"{MENU}" $yellow<><><><><><><>"
echo
echo $indigo"	~"$cyan"{"$white"C"$cyan"}"$green"."$yellow"Auto Deface / Webdav"$cyan
echo
echo $cyan"＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿"
echo
echo $indigo"  +"$cyan"{"$white"T"$cyan"}"$purple"."$green"LIVE TARGET"$indigo"      +" $cyan"{"$white"Q"$cyan"}"$green"Quit"$cyan
echo $cyan"＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿"
echo $indigo"=============================================================="
echo
